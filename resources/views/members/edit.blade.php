                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" required value="{{old('name') ?? $member->name}}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" id="cpf" name="cpf" class="form-control @error('cpf') is-invalid @enderror" required value="{{old('cpf') ?? $member->cpf }}">
                            @error('cpf')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" id="rg" name="rg" class="form-control @error('rg') is-invalid @enderror" required value="{{old('rg') ?? $member->rg }}">
                            @error('rg')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" name="birth_place" class="form-control @error('birth_place') is-invalid @enderror" required value="{{old('birth_place') ?? $member->birth_place}}">
                            @error('birth_place')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="date" name="conversion_date" class="form-control @error('conversion_date') is-invalid @enderror" required value="{{old('conversion_date') ?? $member->conversion_date}}">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="mother_name" class="form-control @error('mother_name') is-invalid @enderror" required value="{{old('mother_name') ?? $member->mother_name }}">
                            @error('mother_name')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="father_name" class="form-control @error('father_name') is-invalid @enderror" required value="{{old('father_name') ?? $member->father_name }}">
                            @error('father_name')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
