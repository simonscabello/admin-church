            ...
            <form method="POST" action="{{route('reports.store')}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="month" name="month" class="form-control @error('month') is-invalid @enderror" required value="{{old('month')}}">
                        @error('month')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="entries" class="form-control @error('entries') is-invalid @enderror" required value="{{old('entries')}}">
                        @error('entries')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="exits" class="form-control @error('exits') is-invalid @enderror" required value="{{old('exits')}}">
                        @error('exits')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
